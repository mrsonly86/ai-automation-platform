...
], validate_request_1.validateRequest, authController.login.bind(authController));
...
], validate_request_1.validateRequest, authController.verifyMFA.bind(authController));
// SSO endpoints
...
router.post('/forgot-password', [
    (0, express_validator_1.body)('email').isEmail().normalizeEmail()
], validate_request_1.validateRequest, authController.forgotPassword.bind(authController));
router.post('/reset-password', [
    (0, express_validator_1.body)('token').notEmpty(),
    (0, express_validator_1.body)('password').isLength({ min: 8 })
], validate_request_1.validateRequest, authController.resetPassword.bind(authController));
// Session management
